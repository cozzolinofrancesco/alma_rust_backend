...
export async function POST(request: NextRequest) {
    try {
        ...
        const { title, content, projectId, folderName, fileName }: ExportAgentRequest = await request.json();
        ...
        return NextResponse.json({
            ...
            message: 'AI agent export saved successfully',
        });

    } catch (error) {
        console.error('Error exporting AI agent result:', error);
